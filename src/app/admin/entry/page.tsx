        ...
        <div className="border-b border-[#30363d] bg-[#161b22]/50 backdrop-blur-md sticky top-[65px] z-30">
          <div className="max-w-[1280px] mx-auto px-4 md:px-8 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {saving && (
                <span className="text-xs text-[#8b949e] animate-pulse hidden sm:inline">
                  Saving changes...
                </span>
              )}
              <button
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="pt-2">
                    <TiptapEditor
                      content={content}
                      onChange={setContent}
                      placeholder="Start documenting your OJT journey here..."
                    />
                  </div>
                </div>
              </div>
            ...
            <aside className="w-full lg:w-[320px] shrink-0 space-y-6">
              ...
              <div className="p-4 bg-[#1f6feb]/5 border border-[#1f6feb]/20 rounded-xl flex gap-3">
                ...
                <p className="text-[11px] text-[#8b949e] leading-relaxed">
                  Your entry will be visible on the public journal timeline
